                    ...
                    if(networkInfo == null){
                        ...
                        if(username == null || username.equals("") || password == null || password.equals("") || confirm==null || confirm.equals("")){
                            ...
                            if(!password.equals(confirm)){//两次密码不一样
                                new AlertDialog.Builder(RegisterActivity.this).setTitle("错误").setMessage("两次密码输入不一样，请重新输入").setPositiveButton("确认",new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.dismiss();
                                    }
                                ...
                                if(responseInfo.equals("success")){
                                    ...
                                    }).setTitle("错误").setMessage("该用户名已被注册，请更换用户名重新注册").setPositiveButton("确认",new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            dialog.dismiss();
                                        }
                                    ...
                                    }).setTitle("错误").setMessage("注册失败，是否重新注册？").setPositiveButton("确认",new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            dialog.dismiss();
                                        }
