                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(networkInfo == null){
                        ...
                        if(username == null || password == null){
                            new AlertDialog.Builder(LoginActivity.this).setTitle("错误").setMessage("用户名或密码不能为空").setPositiveButton("确认",null).show();
                        }
                        else{
                            ...
                            if(responseInfo.equals("success")){//登录成功
                                ...
                                }).setTitle("错误").setMessage("用户名或密码错误，请重新输入").setPositiveButton("确认",new DialogInterface.OnClickListener() {
                                    @Override
